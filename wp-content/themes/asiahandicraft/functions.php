 ...
 */
function asiahandicraft_setup()
{
    /**
     * Make theme available for translation.
     * Translations can be placed in the /languages/ directory.
     */
    load_theme_textdomain('asiahandicraft', get_template_directory() . '/languages');
    ...
    register_nav_menus(array(
        'primary-menu' => __('Primary Menu', 'asiahandicraft'),
        'secondary-menu' => __('Secondary Menu', 'asiahandicraft')
    ));
...
add_action('after_setup_theme', 'asiahandicraft_setup');
 ...
 */
function asiahandicraft_widgets_init()
{
    register_sidebar(array(
        'name' => __('Primary Sidebar', 'asiahandicraft'),
        'id' => 'primary-sidebar',
    ...
    register_sidebar(array(
        'name' => __('Secondary Sidebar', 'asiahandicraft'),
...
add_action('widgets_init', 'asiahandicraft_widgets_init');

/**
 * Enqueue scripts and styles.
 */
function asiahandicraft_scripts()
{
    // css
    // style.css
...
add_action('wp_enqueue_scripts', 'asiahandicraft_scripts');
 ...
 */
function asiahandicraft_custom_excerpt_length( $length) {
    return 10;
}
add_filter( 'excerpt_length', 'asiahandicraft_custom_excerpt_length', 999 );
 ...
 */
function asiahandicraft_excerpt_more( $more ) {
    return '...';
}
add_filter( 'excerpt_more', 'asiahandicraft_excerpt_more' );